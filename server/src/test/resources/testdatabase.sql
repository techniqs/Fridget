...
ALTER TABLE Comment
ADD CONSTRAINT fk_comment_bill_id FOREIGN KEY (bill_id) REFERENCES Bill (id);
...
INSERT INTO UserGroup VALUES (1, 'boys flat sharing');
INSERT INTO UserGroup VALUES (2, 'girls flat sharing');
INSERT INTO UserGroup VALUES (3, 'flat sharing');
INSERT INTO UserGroup VALUES (4, 'students flat sharing');
INSERT INTO UserGroup VALUES (5, 'trip to Switzerland');
INSERT INTO UserGroup VALUES (6, 'skiing weekend');
INSERT INTO UserGroup VALUES (7, 'trip to Italy');
INSERT INTO UserGroup VALUES (8, 'clubbing');
INSERT INTO UserGroup VALUES (9, 'dinner');
INSERT INTO UserGroup VALUES (10, 'lunch');
...
INSERT INTO Bill VALUES (1, 1000, 1, 'Groceries', 'for the weekend', now(), now(), FALSE, 1, 10000, 2, 1, 2);
INSERT INTO Bill VALUES (2, 1000, 2, 'Groceries', 'for the weekend', now(), now(), FALSE, 1, 10000, 2, 1, 2);
INSERT INTO Bill VALUES (3, 1000, 3, 'Groceries', 'for the weekend', now(), now(), FALSE, 1, 10000, 2, 1, 2);
...
INSERT INTO Bill VALUES (7, 4565, 1, 'Vacation', 'for hotel and transportation', now(), now(), FALSE, 3, 08832, 10, 6, 7);
INSERT INTO Bill VALUES (8, 4565, 2, 'Vacation', 'for hotel and transportation', now(), now(), FALSE, 3, 08862, 10, 6, 7);
INSERT INTO Bill VALUES (9, 4565, 3, 'Vacation', 'for hotel and transportation', now(), now(), FALSE, 3, 08832, 10, 6, 7);
INSERT INTO Bill VALUES (10, 10001, 1, 'Electronic device', 'new Samsung 3D TV', now(), now(), TRUE, 3, 1338965, 2, 1, 8);
...
INSERT INTO Event VALUES (4, 4, FALSE, now(), 'first group invitation', 5, 2, 1, 1, 1);
...
INSERT INTO Event VALUES (8, 4, FALSE, now(), 'second group invitation', 9, 8, 2, 2, 6);
...
INSERT INTO Comment VALUES (1, now(), 'paid at Billa', 10, 1);
INSERT INTO Comment VALUES (2, now(), 'paid at Billa', 8, 2);
INSERT INTO Comment VALUES (3, now(), 'paid at Billa', 6, 3);
INSERT INTO Comment VALUES (4, now(), 'from our landlord', 2, 4);
INSERT INTO Comment VALUES (5, now(), 'from our landlord', 2, 5);
INSERT INTO Comment VALUES (6, now(), 'from our landlord', 2, 6);
INSERT INTO Comment VALUES (7, now(), 'trip to Switzerland', 8, 7);
INSERT INTO Comment VALUES (8, now(), 'trip to Switzerland', 9, 8);
INSERT INTO Comment VALUES (9, now(), 'trip to Switzerland', 10, 9);
INSERT INTO Comment VALUES (10, now(), 'paid at Saturn', 5, 10);
...
INSERT INTO Transaction VALUES (4, now(), 1000, 4, 5, 5);
